...
flowchart TD
    ...
    UI -->|1. Client API Requests| API
    API -->|2. Check Redis Cache| RedisDB
    RedisDB -->|Cache Hit (JSON)| UI
    RedisDB -.->|Cache Miss| LRU
    LRU -->|3. Check In-Memory Caches| API
    API -.->|Cache Miss / Timeout| Poke
